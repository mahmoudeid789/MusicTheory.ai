...
<template>
    <div class="range__wrapper">
        ...
        <svg class="range__slider" width="320px" height="480px" viewBox="0 0 320 480">
            ...
            <!-- Clipped white marks -->
            <use
                xlink:href="#range__marks"
                class="range__marks__white"
                clip-path="url(#range__slider__clip-path)"
            ></use>
        </svg>
...
(function() {
    ...
    var rangeValueNumberTop = document.querySelector(
        ".range__value__number--top"
    );
    var rangeValueNumberBottom = document.querySelector(
    ...
    function updateValue() {
        ...
        rangeValues.style.transform =
            "translateY(" + (rangeHeight - currentY) + "px)";
        // Apply corresponding `scale` to numbers
        rangeValueNumberTop.style.transform = "scale(" + (1 - scale) + ")";
        rangeValueNumberBottom.style.transform =
            "scale(" + (1 - (scaleMax - scale)) + ")";
    ...
    function elasticRelease() {
        ...
        anime({
            targets: rangeValues,
            translateY:
                rangeHeight - (currentY + lastMouseDy / mouseDyFactor / 4),
            duration: 150,
            easing: "linear",
            complete: function() {
    ...
    function mouseDown(e) {
        mouseY = mouseInitialY = e.targetTouches
